...
| Locked contact block preview | The brand-continuity contact strip (Compass + Graeham lockup, gold+black, DRE #01466876) — read-only from identity.json; brand tripwire blocks blocklisted DRE | identity.json / brand vault | none | farming-postcard skill; CLAUDE.md brand rule |
